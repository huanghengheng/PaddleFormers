...
PT_TRAIN_DATASET_PATH = "./tests/fixtures/dummy/ernie/pt-train.jsonl"
PT_EVAL_DATASET_PATH = "./tests/fixtures/dummy/ernie/pt-train.jsonl"

PT_FC_TRAIN_DATASET_PATH = "./tests/fixtures/dummy/function-call/function-call-train.jsonl"
PT_FC_EVAL_DATASET_PATH = "./tests/fixtures/dummy/function-call/function-call-eval.jsonl"

PT_FULL_EXCEPTED_LOSS = 11.931005
PT_FULL_REUSME_EXCEPTED_LOSS = 11.920915
PT_FULL_EXPECTED_RESULT = [[22407, 90612, 90612, 90612, 90612, 90612, 90612, 90612, 90612, 90612]]

PT_LORA_EXCEPTED_LOSS = 11.94409
PT_LORA_REUSME_EXCEPTED_LOSS = 11.943027
PT_LORA_EXPECTED_RESULT = [[22407, 120525, 77505, 113631, 47887, 134141, 122487, 61092, 40897, 40601]]

PT_FULL_TP_PP_EXCEPTED_LOSS = 11.945682
PT_FULL_TP_PP_REUSME_EXCEPTED_LOSS = 11.938123
PT_FULL_TP_PP_EXPECTED_RESULT = [[22407, 90612, 90612, 90612, 90612, 90612, 90612, 90612, 90612, 90612]]

PT_LORA_TP_PP_EXCEPTED_LOSS = 11.94778
PT_LORA_TP_PP_REUSME_EXCEPTED_LOSS = 11.941195
PT_LORA_TP_PP_EXPECTED_RESULT = [[22407, 120525, 77505, 113631, 47887, 134141, 122487, 61092, 40897, 11806]]

PT_FC_EXCEPTED_LOSS = 11.945908
PT_FC_REUSME_EXCEPTED_LOSS = 11.939684
PT_FC_EXPECTED_RESULT = [[22407, 90612, 90612, 90612, 90612, 90612, 90612, 90612, 90612, 90612]]
...
class PTTrainTest(unittest.TestCase):
    ...
    def test_pt_full(self):
        ...
        update_args = {
            ...
            "train_dataset_path": PT_TRAIN_DATASET_PATH,
            "eval_dataset_path": PT_EVAL_DATASET_PATH,
        ...
        pt_full_log_file = os.path.join(LOG_PATH, "pt_full.log")
        ...
        pt_full_reusme_log_file = os.path.join(LOG_PATH, "pt_full_reusme.log")
        ...
        self.pttrain_tester.assert_loss(reusme_p.stdout, PT_FULL_REUSME_EXCEPTED_LOSS)

        # test model generate
        EXPECTED_RESULT = paddle.to_tensor(PT_FULL_EXPECTED_RESULT)
    ...
    def test_pt_lora(self):
        ...
        pt_lora_log_file = os.path.join(LOG_PATH, "pt_lora.log")
        ...
        pt_lora_reusme_log_file = os.path.join(LOG_PATH, "pt_lora_reusme.log")
        ...
        self.pttrain_tester.assert_loss(reusme_p.stdout, PT_LORA_REUSME_EXCEPTED_LOSS)
        ...
        EXPECTED_RESULT = paddle.to_tensor(PT_LORA_EXPECTED_RESULT)
    ...
    def test_pt_full_tp_pp(self):
        ...
        pt_full_tp_pp_log_file = os.path.join(LOG_PATH, "pt_full_tp_pp.log")
        ...
        pt_full_tp_pp_reusme_log_file = os.path.join(LOG_PATH, "pt_full_tp_pp_reusme.log")
        ...
        self.pttrain_tester.assert_loss(reusme_p.stdout, PT_FULL_TP_PP_REUSME_EXCEPTED_LOSS)
        # test model generate
        EXPECTED_RESULT = paddle.to_tensor(PT_FULL_TP_PP_EXPECTED_RESULT)
        self.pttrain_tester.create_and_check_model_generate(output_dir, EXPECTED_RESULT)
    ...
    def test_pt_lora_tp_pp(self):
        ...
        pt_lora_tp_pp_log_file = os.path.join(LOG_PATH, "pt_lora_tp_pp.log")
        ...
        pt_lora_tp_pp_reusme_log_file = os.path.join(LOG_PATH, "pt_lora_tp_pp_reusme.log")
        ...
        self.pttrain_tester.assert_loss(reusme_p.stdout, PT_LORA_TP_PP_REUSME_EXCEPTED_LOSS)
        ...
        # test lora_merge_model generate
        EXPECTED_RESULT = paddle.to_tensor(PT_LORA_TP_PP_EXPECTED_RESULT)
        self.pttrain_tester.create_and_check_model_generate(lora_merge_output_dir, EXPECTED_RESULT)

    # def test_pt_full_offline(self):
    #     output_dir = os.path.join(OUTPUT_DIR, "pt_full")
    #     update_args = {
    #         "model_name_or_path": MODEL_NAME_OR_PATH,
    #         "train_dataset_path": PT_TRAIN_DATASET_PATH,
    ...
    #         "save_steps": SAVE_STEPS,
    #     }
    #     config_path = os.path.join(CONFIG_PATH, "full_offline_data.yaml")
    #     updated_config_path = self.pttrain_tester.update_training_args(config_path, output_dir, update_args)
    #     # cli mode
    #     cmd = [
    #         "paddleformers-cli",
